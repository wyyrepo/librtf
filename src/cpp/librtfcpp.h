...
// 		}
	...
	public:
		virtual ~ fonts() { }
		virtual void register_font( int num, const char * fontname ) 	=0;
	...
	public:
		...
		virtual void keywords(string keywords )				=0;
		virtual void author(string author )				=0;
		virtual void summary( summary_categories cat, int param)	=0;

		virtual char* translate_char(int);

		virtual void print( string )					=0;
		virtual void print_symbol( string )				=0;
		virtual void print_forced_space( )				=0;
		virtual int  print_unicode( int )				=0;
		virtual void hyperlink( string )				=0;
		virtual void hyperlink_base ( string )				=0;
